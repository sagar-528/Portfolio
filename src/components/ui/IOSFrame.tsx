...
interface IOSStatusBarProps { dark?: boolean; time?: string; }
...
export function IOSDevice({ children, width = 402, height = 874, dark = false, statusBar = true }: IOSDeviceProps) {
  return (
    <div className="phone-outer" style={{
      ...
      <div className="phone-home-bar">
        <div style={{ background: dark ? 'rgba(255,255,255,0.7)' : 'rgba(0,0,0,0.25)' }} />
      </div>
    </div>
  );
}
